...
from fhcrc_clinical.SocialHistories.SystemUtilities.Configuration import ADJUDICATION_DIR, ADJUDICATED_BATCH_0
...
def main():
    ...
    # save to pickle
    Pickle.dump(patients, open(ADJUDICATED_BATCH_0, "wb"))
