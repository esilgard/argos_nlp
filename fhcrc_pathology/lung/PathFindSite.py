...
__version__='PathFindSite1.0'

def get(dictionary):
    '''
    extract the site from the text of the pathology report   
    ...
    '''
    return_dictionary={"name":"PathFindSite","value":None,"confidence":0.0,"algorithmVersion":__version__,
                       "startStops":[]}
