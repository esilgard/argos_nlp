...
class PathCollectedDate(OneFieldPerReport):
    ''' find the signed date in the pathology report '''
    __version__ = 'PathCollectedDate1.0'
    def __init__(self):
        super(PathCollectedDate, self).__init__()
        self.field_name = 'PathCollectedDate'
        self.regex = r'COLLECTED:[ ]*([A-Z][a-z]{2,4})[ ]+([\d]{1,2})[ ]+([\d]{4})'
        self.confidence = 1
