...
def get(nlp_engine_path,arguments):
    ...
    try:
        ...
        try:
            ...
            sys.stderr.write('FATAL ERROR: json could not load metadata dictionary file or the UI groupings file, potential formatting error.  program aborted.')
            sys.exit(1)
    except:
        sys.stderr.write('FATAL ERROR: either metadata dictionary or groupings file not found.  program aborted.')
        sys.exit(1)
